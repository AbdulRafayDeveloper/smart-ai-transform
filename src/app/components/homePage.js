...
const Homepagesection = () => {
  return (
    <>
      {/* Section 1 */}
      <section className="relative h-screen flex flex-col justify-center bg-green-50 bg-cover bg-center ">
        <div className="container mx-auto flex flex-col-reverse lg:flex-row items-center">
          ...
          <div className="lg:w-1/2 text-center lg:text-left px-6 md:px-12">
            ...
            <p className="text-lg md:text-xl leading-relaxed text-foreground mb-9 animate-text-reveal-paragraph">
              ...
              images with precision. Our advanced tools offer seamless, fast,
              and accurate transformations for content creators, businesses, and
              professionals.
            </p>
            <Link
              href="/auth/register"
              className="py-4 px-6 bg-foreground text-background rounded-lg shadow-lg text-sm"
            >
              Register Now
            </Link>
          </div>
          ...
          <div className="lg:w-1/2 flex justify-center items-center mt-9">
            <div className="relative w-full max-w-[80%] h-[400px]">
              <Image
                src="/img/home.jpg"
                alt="AI Tools"
                fill
